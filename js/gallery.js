...
const markup=images.map((image)=>`<li class="gallery-item"><a class="gallery-link" href="${image.original}"><img class="gallery-image" src="${image.preview}" data-sourse="${image.original} alt="${image.description}"/></a></li>`).join("");
